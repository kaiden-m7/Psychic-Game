$(document).ready(function) {
    ...
    document.onkeyup = function(event) { //once key is 'pressed' it becomes players answer
    numGuesses--;
...
var updateGuessesSoFar = function() { //showing users answers and seperateing by a comma with a space
    document.getElementById('#guessedLetters').innerHTML = "What you have guessed so far: " + guessedLetters.join(', ');
  };
